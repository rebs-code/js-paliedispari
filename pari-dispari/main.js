...
if (myNumber >= 1 && myNumber <= 5 && (myChoice === "pari" || myChoice === "dispari")) {
    console.log(`Hai inserito il numero ${myNumber}`);
    console.log(`Hai scelto ${myChoice}`);
    const sum = myNumber + randomNum();
    result(sum);
} else {
    console.log("Il numero inserito e/o la scelta non è valida. Inserisci un numero da 1 a 5 e scegli 'pari' o 'dispari'.");
}
